<template>
  <div ref="threeContainer" style="width: 300px; height: 300px;" id="threeContainer"></div>
</template>
...
onMounted(() => {
  ...
  // Create a camera
  camera = new THREE.PerspectiveCamera(50, threeContainer.value.offsetWidth / threeContainer.value.offsetHeight, 0.1, 2000);
  camera.position.z = 5;
  ...
  loader.load('/memoryCards/03.glb', (gltf) => {
    model = gltf.scene;
